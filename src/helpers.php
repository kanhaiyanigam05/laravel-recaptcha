...
use Kanhaiyanigam05\ReCaptcha\Facades\ReCaptcha;
...
if (!function_exists('recaptcha')) {
     ...
     */
    function recaptcha(): \Kanhaiyanigam05\ReCaptcha\ReCaptchaBuilder
    {
...
if (!function_exists('recaptchaRuleName')) {
    ...
    function recaptchaRuleName(): string
    {
        ...
        return \Kanhaiyanigam05\ReCaptcha\ReCaptchaBuilder::DEFAULT_RECAPTCHA_RULE_NAME;
    }
}
...
if (!function_exists('recaptchaFieldName')) {
    ...
    function recaptchaFieldName(): string
    {
        ...
        return \Kanhaiyanigam05\ReCaptcha\ReCaptchaBuilder::DEFAULT_RECAPTCHA_FIELD_NAME;
    }
}
